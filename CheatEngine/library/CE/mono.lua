...
---@return VariableType
function monoTypeToVarType(monoType) end
...
function mono_image_get_filename(image) end


---@param image Address # An address of an image
---@return MonoClass[]
function mono_image_enumClasses(image) end

---@param class Address # The address of a class
---@return boolean # Whether the class is generic
function mono_class_isgeneric(class) end


---@param class Address # The address of a class
---@return boolean # Whether the class is an il2cpp
function mono_isil2cpp(class) end


---@param class Address # The address of a class
---@return Address # The parent class address if nested. 0 if not nested
function mono_class_getNestingType(class) end
...
function mono_class_getVTable(domain, class) end


---@param class Address # The address of a class
---@return Address | nil # The address of the class' VTable or nil if monopipe is broken.
---@return string | nil # An error string if class and domain are nil
function mono_class_getVTable(class) end
...
function mono_class_getStaticFieldAddress(domain, class) end

---@param class Address # The address of a class
---@return Address # Address of static fields of the class
function mono_class_getStaticFieldAddress(class) end


---@param class Address # The address of a class
---@param includeParents boolean # Whether to include fields of parent classes class inherits from
---@return MonoClassField[] #
function mono_class_enumFields(class, includeParents) end
...
function mono_getJitInfo(address) end
...
function mono_getStaticFieldValue(vtable, field) end
...
function mono_object_findRealStartOfObject(address, maxSize) end


---@param image Address # Address of the image to find class in
---@param namespace SymbolAddress | nil # Address of namespace to search class in
...
function mono_image_findClass(image, namespace, className) end
...
---@param className string # The name of the class to search for
---@return Address # Address of the class or 0 if not found or monopipe is broken 
function mono_image_findClassSlow(image, namespace, className) end


---@param namespace SymbolAddress # The address of the namespace
---@param className string # The name of the class to find
---@return Address # The class' address or 0 if not found
function mono_findClass(namespace, className) end

---@param className string # The name of the class to find
---@return Address # The class' address or 0 if not found
function mono_findClass(className) end
...
function mono_class_findMethod(class, methodName) end
...
---@return Address | nil # Address of method or 0 if not found. Is nil if method name is nil or monopipe is broken
function mono_findMethod(namespace, className, methodName) end

---@param className string # The name of the class to find
---@param methodName string | nil # Name of method of class to search for
---@return Address | nil # Address of method or 0 if not found. Is nil if method name is nil or monopipe is broken
function mono_findMethod(className, methodName) end
...
function mono_image_findMethodByDesc(image, methodDescription) end

---Identical to mono_image_findMethodByDesc for old scripts that use this legacy method that was mislabeled.
---@param image Address # Address of the image to search
---@param methodDescription string # A description of a method to search
---@return Address # The address of the method found or 0 if not found or parameters are nil
function mono_class_findMethodByDesc(image, methodDescription) end
...
function mono_findMethodByDesc(assemblyName, methodDescription) end
...
function mono_method_getHeader(method) end
...
function mono_method_disassemble(method) end
